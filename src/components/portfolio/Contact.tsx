...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      icon: MapPin,
      label: "Location",
      value: "Stockholm, Sweden • Milan, Italy",
      href: null,
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Interested in algorithmic systems, data analysis pipelines, or
            security engineering collaborations? Let&apos;s connect and explore
            potential synergies.
          </p>
        </div>
